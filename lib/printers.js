...
var printBrowserErrors =
      exports.printBrowserErrors =
        function printBrowserErrors(rainbowify, browserErrors) {
          if (rainbowify && browserErrors)  {
            ...
            browserErrors.forEach(function(errorObj, i, arr) {
              write('\n');
...
var printTestFailures =
      exports.printTestFailures =
        function printTestFailures(errorData, stats, suppressErrorReport) {
          write("\n");
          write("\n");
          write("\n");
          write("\n");
          ...
          if (!suppressErrorReport && errorData.length) {
            write(clc.red('Failed Tests:\n'));
            printSuitesArray(errorData, 'red');
          }
